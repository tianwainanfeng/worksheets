...
url = "https://mybreathtaking.com/view.php?dir=worksheets&file=weather_table.pdf"
...
img.save("outputs/weather_table_qr.png")  # 保存不带文字的二维码
...
new_img.save("outputs/weather_table_qr_with_text.png")  # 保存带文字的二维码
